...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="newrule.aspx.cs" Inherits="SharePointProject1.Layouts.Permission.sp2010.newrule"  %>
...
<asp:RequiredFieldValidator ID="RequiredFieldValidator1"  ControlToValidate="TextBoxTitle" ValidationGroup="ValidateGroup"  runat="server" ErrorMessage="<%$Resources:PermissionPages,error_required%>"></asp:RequiredFieldValidator>
              </Template_Control>
