...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rules.aspx.cs" Inherits="Permission.Layouts.Permission.rules"  %>
			...
			<colgroup>
                ...
                <th scope="col" class="ms-vh2-nofilter"> <asp:Literal ID="Literal6" runat="server" Text="<%$Resources:PermissionPages,stop_heritage%>" /></th>
                     ...
                     <tr>
                         ...
                         <td  valign="top">
                        <asp:LinkButton  OnClientClick="return confirmDelete()"  runat="server">
